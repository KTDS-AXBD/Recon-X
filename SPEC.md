...
- [→] F359 (AIF-REQ-035 Phase 3 S-4, **P2 → Sprint 251 확장**, 세션 263 2026-05-04 scope 확장): **TD-22 + TD-23 + BL-028 + BL-024/025/029 통합 — round-trip 신뢰도 91.7% → 95%+ 회복**. 원안(2h) → 사용자 결정으로 4종 sub-task 통합(~8h):
