...
- [ ] F383 (AIF-REQ-036 Should, **P2**, Sprint 229+ 이관): **AXIS DS Tier 3: 도메인 특화 컴포넌트 3종 PR 생성** — SpecSourceSplitView/ProvenanceInspector/StageReplayer를 `IDEA-on-Action/AXIS-Design-System` 레포에 재활용 가능한 형태로 기여. Sprint 227에서는 F401 P1 복구 cycle 3회 집중으로 미착수
- [ ] F384 (AIF-REQ-036 Should, **P2**, Sprint 229+ 이관): **Guest/Demo 모드** — 읽기 전용 데이터. 외부 데모/영업용. Sprint 227 F401 성공으로 `VITE_DEMO_MODE` + AuthContext 기반은 확보됨. 다음 Wave에서 UI shell 추가
