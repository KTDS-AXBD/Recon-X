...
| 1차 검토 | 2026-04-22 | QA/검수, Rollback/Failover, 운영/배포, 테스트/리스크/기술부채 등 다수 보완 | Conditional |
...
*이 문서는 `/ax:req-interview` 스킬에 의해 자동 생성됐으며, Round 1 apply (ChatGPT via OpenRouter, 17건 변경) + 수동 잘림 복구를 거침. Round 2 검토로 진입 예정.*